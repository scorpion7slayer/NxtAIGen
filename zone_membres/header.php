        ...
        <div class="max-w-3xl mx-auto px-4 py-3 flex items-center justify-between">
            ...
            <nav class="flex items-center gap-4">
                <?php if (isset($_SESSION['user_id'])): ?>
                    ...
                    <a href="dashboard.php" class="text-sm text-neutral-400 hover:text-green-400 transition-colors">
                        <i class="fa-solid fa-user mr-1.5"></i>Compte
                    </a>
                    <a href="logout.php" class="text-sm text-neutral-500 hover:text-red-400 transition-colors">
                        <i class="fa-solid fa-sign-out-alt"></i>
                    </a>
                <?php else: ?>
                    <a href="login.php" class="text-sm text-neutral-400 hover:text-green-400 transition-colors">Connexion</a>
                    <a href="register.php" class="px-3 py-1.5 text-sm bg-green-600 hover:bg-green-500 text-white rounded-lg transition-colors">Inscription</a>
                <?php endif; ?>
            </nav>
        </div>
    </header>